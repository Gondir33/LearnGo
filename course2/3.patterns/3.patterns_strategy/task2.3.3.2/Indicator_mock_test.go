...
func TestNewIndicatorSMA(t *testing.T) {
	...
	got := NewIndicatorSMA(exchange)
	want := &IndicatorSMA{exchange: exchange}
	assert.Equal(t, want.exchange, got.exchange)
}

func TestNewIndicatorEMA(t *testing.T) {
	exchange := NewMockExchanger(t)
	got := NewIndicatorEMA(exchange)
	want := &IndicatorEMA{exchange: exchange}
	assert.Equal(t, want.exchange, got.exchange)
}
...
func TestIndicator_SMA(t *testing.T) {
	...
	exchange := NewMockExchanger(t)
	InSMA := NewIndicatorSMA(exchange)
	tests := []struct {
		name    string
		i       *GeneralIndicator
		args    args
	...
	for _, tt := range tests {
		...
		got, err := tt.i.GetData(tt.args.pair, tt.args.limit, tt.args.period, tt.args.from, tt.args.to, InSMA)
...
func TestIndicator_EMA(t *testing.T) {
	...
	exchange := NewMockExchanger(t)
	InEMA := NewIndicatorEMA(exchange)
	tests := []struct {
		name    string
		i       *GeneralIndicator
		args    args
	...
	for _, tt := range tests {
		...
		got, err := tt.i.GetData(tt.args.pair, tt.args.limit, tt.args.period, tt.args.from, tt.args.to, InEMA)
		if (err != nil) != tt.wantErr {
